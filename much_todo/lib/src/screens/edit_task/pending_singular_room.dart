...
class PendingSingularRoom extends StatefulWidget {
  final Room? selectedRoom;
  final ValueChanged<Room?> onRoomChange;

  const PendingSingularRoom({super.key, this.selectedRoom, required this.onRoomChange});

  @override
  State<PendingSingularRoom> createState() => _PendingSingularRoomState();
}
...
class _PendingSingularRoomState extends State<PendingSingularRoom> {
  Room? _selectedRoom;
