...
class MoreScreenSkeleton extends StatefulWidget {
  const MoreScreenSkeleton({super.key});

  @override
  State<MoreScreenSkeleton> createState() => _MoreScreenSkeletonState();
}

class _MoreScreenSkeletonState extends State<MoreScreenSkeleton> {
  @override
