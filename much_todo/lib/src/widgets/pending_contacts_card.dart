...
class PendingContactsCard extends StatefulWidget {
  ...
  const PendingContactsCard({super.key, required this.contacts, required this.onChange, this.showAdd = true});

  @override
  State<PendingContactsCard> createState() => _PendingContactsCard1State();
}
...
class _PendingContactsCard1State extends State<PendingContactsCard> {
