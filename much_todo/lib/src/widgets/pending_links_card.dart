...
class PendingLinksCard extends StatefulWidget {
  final ValueChanged<List<String>> onChange;
  final List<String> links;

  const PendingLinksCard({super.key, this.links = const [], required this.onChange});

  @override
  State<PendingLinksCard> createState() => _PendingLinksCardState();
}
...
class _PendingLinksCardState extends State<PendingLinksCard> {
